...
$alp_db = SE_CONTENT.'/database/'.$addon_info['addon']['database'];

if(!is_file("$alp_db")) {

	$sql_entries_table = generate_sql_query(__DIR__."/tpl-entries.php");
	$sql_prefs_table = generate_sql_query(__DIR__."/tpl-preferences.php");
...
if(!is_file("$alp_db")) {
	echo'<div class="alert alert-error">Die Datenbank existiert nicht. ('.$alp_db.')</div>';
}
